...
<section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/mybg.jpg);">
                ...
                <div class="section-heading dark text-center">
                    ...
                    <!-- Card deck -->
                                    ...
                                    <div id="carouselExampleFade" class="card-img-top carousel slide carousel-fade" data-interval="7500" data-ride="carousel">
                                            <div class="carousel-inner">
                                              <div class="carousel-item active">
                                                <img class="d-block w-100" src="img/download-img/conversation-1.gif"
                                                  alt="First slide">
                                              </div>
                                              <div class="carousel-item">
                                                <img class="d-block w-100" src="img/download-img/conversation-2.gif"
                                                  alt="Second slide">
                                              </div>
                                              <div class="carousel-item">
                                                <img class="d-block w-100" src="img/download-img/conversation-3.gif"
                                                  alt="Third slide">
                                              </div>
                                            </div>                                            
                                    </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <!--Card image-->
                            <div class="view overlay">
                            <img class="card-img-top" src="img/download-img/talk.gif"
                                alt="Card image cap">
                            <a href="#!">
                                <div class="mask rgba-white-slight"></div>
                            </a>
                        ...
                        <div class="card mb-4">
                            ...
                            <!--Card image-->
                            <div class="view overlay">
                            <img class="card-img-top" src="img/download-img/handshake.gif"
                                alt="Card image cap">
                            <a href="#!">
                                <div class="mask rgba-white-slight"></div>
                            </a>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4 mb-4 wow fadeInUpBig " data-wow-delay="0.2s">
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/sante.gif" alt="santé">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
                            ...
                            <div class="col-6 col-md-4 mb-4 wow fadeInUpBig " data-wow-delay="0.4s">
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/dons-prets.gif" alt="Card image cap">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
                            ...
                            <div class="col-6 col-md-4 mb-4 wow fadeInUpBig " data-wow-delay="0.6s">
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/bricolage.gif" alt="Card image cap">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
                            ...
                            <div class="col-6 col-md-4 mb-4 wow fadeInUpBig " data-wow-delay="0.8s">
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/adm-info.gif" alt="Card image cap">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
                            ...
                            <div class="col-6 col-md-4 mb-4 wow fadeInUpBig " data-wow-delay="1s">
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/Transport.gif" alt="Card image cap">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <div class="view view-cascade overlay">
                                        ...
                                        <div id="carouselExampleFade" class="card-img-top carousel slide carousel-fade" data-interval="5000" data-ride="carousel">
                                                <div class="carousel-inner">
                                                  <div class="carousel-item active">
                                                    <img class="d-block w-100" src="img/download-img/autres1.gif"
                                                      alt="First slide">
                                                  </div>
                                                  <div class="carousel-item">
                                                    <img class="d-block w-100" src="img/download-img/autres2.gif"
                                                      alt="Second slide">
                                                  </div>
                                                  <div class="carousel-item">
                                                    <img class="d-block w-100" src="img/download-img/autres3.gif"
                                                      alt="Third slide">
                                                  </div>
                                                </div>                                            
                                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-6 mb-4 wow fadeInUpBig " data-wow-delay="1.4s">
                                ...
                                <div class="card h-100 card-cascade wider">
                                  ...
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/bénévolat.gif" alt="Card image cap">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
                            ...
                            <div class="col col-md-6 mb-4">
                                ...
                                <div class="card h-100 card-cascade wider wow fadeInUpBig " data-wow-delay="1.8s">
                                  ...
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img class="card-img-top" src="img/download-img/services-pro.gif" alt="Card image cap">
                                    <a href="#!">
                                      <div class="mask rgba-white-slight"></div>
                                    </a>
                                  </div>
